...
\begin{itemize}[nolistsep]
    ...
    \item \acs{TCP} (Wi-Fi)
    \item \acs{UDP} (Wi-Fi)
    \item Bluetooth\footnote{Bluetooth support is currently in development and not yet supported.}
\end{itemize}
...
\textbf{Housing}
\begin{itemize}[nolistsep]
    \item \acs{IP67}\footnote{\acs{IP67} is currently unconfirmed. Third-party testing to complete in 2022.}
