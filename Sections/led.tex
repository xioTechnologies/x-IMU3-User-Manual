...
The \ac{LED} can be controlled by the user using the blink, strobe and colour commands.  See \Fref{sec:blinkCommand}, \Fref{sec:strobeCommand} and \Fref{sec:colourCommand} for a description of each command.
